...
public class Task4_experiment {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		// TODO Auto-generated method stub
		String mlFile = "dataFile" + File.separator + "100k.dat";
		String detailFile = "Results" + File.separator + "Task_4" +File.separator+ 
				"Details.txt";
		...
		for (int i = 50; i <= 600; i+=50) {
			...
			String CSVFile = "Results" + File.separator + "Task_4" +File.separator+ 
					"RMSElistK_"+i+".csv";
			// write csv file
			try {
