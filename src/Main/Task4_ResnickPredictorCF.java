...
public class Task4_ResnickPredictorCF {
	public static void main(String[] args) {
		...
		PredictorInterface pre=new ResnickPredictor();
		NeighbourMap neighbour=new KNearestNeighbour(100);
		...
		String CSVFile = "Results" + File.separator + "Task_4"+File.separator+"RMSElist.txt";
		//write csv file
		try {
