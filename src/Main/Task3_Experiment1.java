...
public class Task3_Experiment1 {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		String mlFile = "dataFile" + File.separator + "100k.dat";
		String detailFile = "Results" + File.separator + "Task_3" + File.separator +"Experiment1"+File.separator+ 
				"Details.txt";
		...
		for (double i = 0.1; i <=2.0; i+=0.1) {
			...
			NeighbourMap neighbour =new SimilarityThresholdNeighbour(i);
			...
			String CSVFile = "Results" + File.separator + "Task_3" + File.separator +"Experiment1"+File.separator+ 
					"RMSElistThreshold_"+i+".csv";
			// write csv file
			try {
